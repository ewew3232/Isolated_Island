;メッセージレイヤの定義
		...
		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=28 x=20 y=25 bold="" edge="undefined" shadow=""]
		...
		[position layer="message1" width=920 height=580 top=20 left=20 ]
